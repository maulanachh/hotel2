                            ...
                            <div class="row gy-12">
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['kamar_name'];
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <select wire:model="jnskmr_id" class="form-select mb-3"
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $jenisKamars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($id); ?>"><?php echo e($name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                        </select>
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['jnskmr_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /var/www/html/jkhomestay/resources/views/livewire/master/msops/nama-kamar/nama-kamar-form.blade.php ENDPATH**/ ?>