        ...
        <div class="card card-height-100">
            ...
            <div class="col-lg-12">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Form Asal Booking</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <form wire:submit.prevent="create">
                        <div class="live-preview">
                            <div class="row gy-12">
                                <div class="col-md-6">
                                    <div>
                                        <label for="aslbooking_name" class="form-label">asal booking</label>
                                        <input wire:model="aslbooking_name" type="text" class="form-control">
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['aslbooking_name'];
...
<?php /**PATH /var/www/html/jkhomestay/resources/views/livewire/master/asal-booking/asal-booking-form.blade.php ENDPATH**/ ?>